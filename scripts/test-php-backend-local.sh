...
TEST_FILE="$TMP_DIR/test-resume.pdf" trap 'rm -rf"$TMP_DIR"' EXIT
...
admin_leads_status="${admin_leads_resp##*$'\n'}" assert_status"$admin_leads_status""200" "GET /api/admin/leads authorized" echo"All smoke tests passed."
