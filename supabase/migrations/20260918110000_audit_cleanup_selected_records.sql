-- Preserve the selected record identities in the cleanup audit entry.
-- This is an additive replacement for the existing admin-only cleanup RPC;
-- it does not alter the allowed resources or deletion semantics.
